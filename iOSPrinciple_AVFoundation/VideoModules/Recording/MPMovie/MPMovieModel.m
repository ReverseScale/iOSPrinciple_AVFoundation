...
@interface MPMovieModel ()<AVCaptureFileOutputRecordingDelegate>
...
#pragma mark - setup
- (void)setUpWithType:(MPVideoViewType )type {
...
- (void)setUpPreviewLayerWithType:(MPVideoViewType )type {
...
- (NSString *)videoFolder {
    NSString *cacheDir = [VideoFileManager cachesDir];
    NSString *direc = [cacheDir stringByAppendingPathComponent:VIDEO_FOLDER];
    if (![VideoFileManager isExistsAtPath:direc]) {
        [VideoFileManager createDirectoryAtPath:direc];
    }
    return direc;
}
//清空文件夹
- (void)clearFile {
    [VideoFileManager removeItemAtPath:[self videoFolder]];
...
- (void)captureOutput:(AVCaptureFileOutput *)captureOutput didFinishRecordingToOutputFileAtURL:(NSURL *)outputFileURL fromConnections:(NSArray *)connections error:(NSError *)error {
    ...
    if ([VideoFileManager isExistsAtPath:[self.videoUrl path]]) {
